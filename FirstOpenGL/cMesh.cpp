...
void cMesh::GeneratePhysicsTriangles(void)
{
	...
	for ( int triIndex = 0; triIndex < this->numberOfTriangles; triIndex++ )
	{
		...
		sVertex_xyz_rgba_n_uv2_bt V0 = this->pVertices[triVert0_index];
		...
		sVertex_xyz_rgba_n_uv2_bt V1 = this->pVertices[triVert1_index];
		...
		sVertex_xyz_rgba_n_uv2_bt V2 = this->pVertices[triVert2_index];
